...
$query = mysql_query();
$q ="SELECT bp.Data,bp.Ora FROM Badge_prof AS bp INNER JOIN Corpo_Docente AS cd ON bp.improntaid = cd.ImprontaID and cd.Username='".$username."' and bp.Data>='".$datada."' and bp.Data<='".$dataa."' ORDER BY bp.Data";
$query = mysql_query($q);
...
?>
				...
				<div class="col-md-4">
          				...
          				<a href="./logprof.php"       class="btn btn-default btn-block">Indietro</a>
